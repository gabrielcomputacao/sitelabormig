...
<head>
    ...
    <title>Labormig - Ensaio de Marshall - DNIT 447/2024-ME</title>
        ...
        <div id="introduction" class="container">
            <section>
                <div class="introduction introduction-ensaios">
                    <h1 class="title-ensaios">Ensaio de Marshall - DNIT 447/2024-ME </h1>
                    <div class="content-introduction">
                        <div class="introduction-text">
                            <p>
                                O ensaio de Marshall é um método utilizado para determinar a resistência à deformação permanente de misturas asfálticas. A norma DNIT 447/2024-ME estabelece os procedimentos para a realização desse ensaio. <br><br>
                                A importância do ensaio de Marshall reside em garantir que as misturas asfálticas sejam resistentes às deformações causadas pelo tráfego. Isso é fundamental para garantir a durabilidade e a segurança das pavimentações.
                            </p>
                        </div>
            ...
            <div class="container process-wrapper">
                ...
                <div class="process">
                    ...
                    <div class="item-process-full">
                        O procedimento de execução envolve a compactação de amostras de mistura asfáltica e a aplicação de cargas para determinar a resistência à deformação permanente. <br><br>

                        Além disso, o ensaio de Marshall também permite avaliar a estabilidade e a deformabilidade das misturas asfálticas. Isso é fundamental para garantir que as pavimentações sejam projetadas para atender às necessidades específicas do tráfego e do clima. <br><br>
                        A norma DNIT 447/2024-ME também estabelece critérios para a verificação da conformidade das misturas asfálticas com os requisitos estabelecidos. Isso inclui a realização de ensaios para verificar a resistência à tração e a adesividade entre as camadas.
                    </div>
                </div>
            </div>
        </section>
