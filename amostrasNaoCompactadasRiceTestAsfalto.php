...
<head>
    ...
    <title>Labormig - Determinação de massa específica máxima em amostras não compactadas Rice Test</title>
        ...
        <div id="introduction" class="container">
            <section>
                <div class="introduction introduction-ensaios">
                    <h1 class="title-ensaios">Determinação de massa específica máxima em amostras não compactadas Rice Test - ABNT NBR 16505 </h1>
                    <div class="content-introduction">
                        <div class="introduction-text">
                            <p>
                                A determinação da massa específica máxima em amostras não compactadas é fundamental para garantir a qualidade das misturas asfálticas. A norma ABNT NBR 16505 estabelece os procedimentos para a realização do ensaio Rice Test. <br><br>
